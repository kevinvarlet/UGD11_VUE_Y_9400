...
@click="deleteData(item.id)"
 ...
 <v-col cols="12">
 <v-text-field label="Biaya" vmodel="form.price" required></v-text-field>
 </v-col>
 <v-col cols="12">
 <v-text-field label="Jenis" vmodel="form.type" required></v-text-field>
 </v-col>
 <v-col cols="12">
 <v-text-field label="Tanggal" vmodel="form.created_at" required></v-text-field>
 </v-col>
 </v-row>
 </v-container>
